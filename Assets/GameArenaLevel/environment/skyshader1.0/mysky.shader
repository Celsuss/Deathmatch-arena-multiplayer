...
Shader "Custom/mysky" {
    Properties {
        ...
        _heightcutoof ("heightcutoof", Range(3, 7)) = 3
...
////// Emissive:
                ...
                float node_9430 = 1.0;
                float3 emissive = ((_HorizonColor.rgb*((_stars_var.rgb*node_5578)+((_cloudshigh_var.rgb*node_5578)+(_cloudslow_var.rgb*node_5578))))+(lerp(_SkyColor.rgb,_HorizonColor.rgb,pow((1.0 - max(0,dot(viewDirection,float3(0,-1,0)))),2.0))+(_LightColor0.rgb*pow(saturate((node_9430 + ( (max(0,dot((-1*lightDirection),viewDirection)) - node_1476) * (0.0 - node_9430) ) / ((1.0 - (node_9367*node_9367)) - node_1476))),5.0)*_SunIntensity)));
